                  ...
                  <CardContent>
                    ...
                    <Typography>
                      <Stack direction="row" spacing={2}>
                        ...
                        {value.status === true && <Chip label="READY" size="small" color="success" />}
                        {/* {value.f === false && value.started == true && <Chip label="STARTED" size="small" color="primary" />} */}
                        {value.status === false && <Chip label="NOT READY" size="small" color="warning" />}
                      </Stack>
                    </Typography>
                  </CardContent>
                </Card>
