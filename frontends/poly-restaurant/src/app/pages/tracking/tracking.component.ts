...
// constructor(private iterableDiffers: IterableDiffers, private tracking : TrackingService) {
...
//     this.tracking.all_orders.push("3")
//     console.log(this.tracking.all_orders)
// }

// ngDoCheck() {
//   let changes = this.iterableDiffer.diff(this.tracking.all_orders);
//   if (changes) {
